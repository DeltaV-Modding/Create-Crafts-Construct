...
public class PaintedSteamEngineBlockEntity extends SteamEngineBlockEntity {
    ...
    public boolean isValid() {
        ...
        if (state.is(com.simibubi.create.AllBlocks.FLUID_TANK.get()))
            return true;
        for (net.neoforged.neoforge.registries.DeferredBlock<net.minecraft.world.level.block.Block> block : net.buildercraft.registry.ModBlocks.PAINTED_FLUID_TANKS) {
