...
public class PaintedFluidTankRenderer extends FluidTankRenderer {
    private static final Map<String, Partials> PARTIALS = new HashMap<>();

    public PaintedFluidTankRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }
    ...
    private static Partials getPartials(BlockState state) {
        ...
        PartialModel gauge = net.buildercraft.registry.ModPartialModels.STEAM_ENGINE_GAUGES.get(steamEnginePath);
        PartialModel dial = net.buildercraft.registry.ModPartialModels.STEAM_ENGINE_DIALS.get(steamEnginePath);
