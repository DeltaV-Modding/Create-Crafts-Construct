...
public class TrainFluidValveRenderer extends KineticBlockEntityRenderer<FluidValveBlockEntity> {
    private static final Map<String, PartialModel> POINTERS = new HashMap<>();

    public TrainFluidValveRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }
