...
public class TrainFluidValveVisual extends ShaftVisual<FluidValveBlockEntity> implements SimpleDynamicVisual {
    ...
    public TrainFluidValveVisual(VisualizationContext context, FluidValveBlockEntity blockEntity, float partialTick) {
        ...
        pointer = instancerProvider()
                .instancer(InstanceTypes.TRANSFORMED, Models.partial(TrainFluidValveRenderer.getPointer(state)))
                .createInstance();
