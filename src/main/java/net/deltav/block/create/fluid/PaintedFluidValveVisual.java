...
public class PaintedFluidValveVisual extends ShaftVisual<FluidValveBlockEntity> implements SimpleDynamicVisual {
    ...
    public PaintedFluidValveVisual(VisualizationContext context, FluidValveBlockEntity blockEntity, float partialTick) {
        ...
        pointer = instancerProvider()
                .instancer(InstanceTypes.TRANSFORMED, Models.partial(PaintedFluidValveRenderer.getPointer(state)))
                .createInstance();
