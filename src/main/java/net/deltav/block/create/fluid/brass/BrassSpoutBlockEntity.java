...
public class BrassSpoutBlockEntity extends SpoutBlockEntity {
    public BrassSpoutBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntityTypes.BRASS_SPOUT.get(), pos, state);
    }
}