...
public class TrainItemDrainItemHandler implements IItemHandler {

    private final TrainItemDrainBlockEntity blockEntity;
    private final Direction side;

    public TrainItemDrainItemHandler(TrainItemDrainBlockEntity be, Direction side) {
        this.blockEntity = be;
        this.side = side;
    }
