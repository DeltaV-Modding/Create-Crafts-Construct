...
public class BrassItemDrainItemHandler implements IItemHandler {

    private final BrassItemDrainBlockEntity blockEntity;
    private final Direction side;

    public BrassItemDrainItemHandler(BrassItemDrainBlockEntity be, Direction side) {
        this.blockEntity = be;
        this.side = side;
    }
