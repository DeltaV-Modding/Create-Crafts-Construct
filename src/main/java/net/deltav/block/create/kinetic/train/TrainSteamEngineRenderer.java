...
public class TrainSteamEngineRenderer extends SafeBlockEntityRenderer<SteamEngineBlockEntity> {
    public TrainSteamEngineRenderer(BlockEntityRendererProvider.Context context) {
        super();
    }
