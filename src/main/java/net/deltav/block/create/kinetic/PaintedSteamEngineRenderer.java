...
public class PaintedSteamEngineRenderer extends SafeBlockEntityRenderer<SteamEngineBlockEntity> {
    public PaintedSteamEngineRenderer(BlockEntityRendererProvider.Context context) {
        super();
    }
