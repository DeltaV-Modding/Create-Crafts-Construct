 ...
 */
public class PaintedGlassPipeVisual extends AbstractBlockEntityVisual<PaintedFluidPipeBlockEntity>
    ...
    public PaintedGlassPipeVisual(VisualizationContext ctx, PaintedFluidPipeBlockEntity blockEntity, float partialTick) {
    ...
    public void beginFrame(Context ctx) {
        ...
        if (!blockEntity.getBlockState().hasProperty(PaintedFluidPipeBlock.GLASS) ||
                !blockEntity.getBlockState().getValue(PaintedFluidPipeBlock.GLASS)) {
            stream.discardExtra();
