 ...
 */
public class BrassGlassPipeVisual extends AbstractBlockEntityVisual<BrassFluidPipeBlockEntity>
    ...
    public BrassGlassPipeVisual(VisualizationContext ctx, BrassFluidPipeBlockEntity blockEntity, float partialTick) {
    ...
    public void beginFrame(Context ctx) {
        ...
        if (!blockEntity.getBlockState().hasProperty(BrassFluidPipeBlock.GLASS) ||
                !blockEntity.getBlockState().getValue(BrassFluidPipeBlock.GLASS)) {
            stream.discardExtra();
