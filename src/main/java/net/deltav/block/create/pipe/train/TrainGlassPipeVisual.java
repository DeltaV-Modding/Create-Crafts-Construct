 ...
 */
public class TrainGlassPipeVisual extends AbstractBlockEntityVisual<TrainFluidPipeBlockEntity>
    ...
    public TrainGlassPipeVisual(VisualizationContext ctx, TrainFluidPipeBlockEntity blockEntity, float partialTick) {
    ...
    public void beginFrame(Context ctx) {
        ...
        if (!blockEntity.getBlockState().hasProperty(TrainFluidPipeBlock.GLASS) ||
                !blockEntity.getBlockState().getValue(TrainFluidPipeBlock.GLASS)) {
            stream.discardExtra();
