 ...
 */
public class PaintedGlassPipeRenderer extends SafeBlockEntityRenderer<PaintedFluidPipeBlockEntity> {

    public PaintedGlassPipeRenderer(BlockEntityRendererProvider.Context context) {
    }

    @Override
    protected void renderSafe(PaintedFluidPipeBlockEntity be, float partialTicks, PoseStack ms,
