...
import static net.deltav.craftsconstruct.MOD_ID;
...
public class CCStress extends ConfigBase {
    ...
    public void registerAll(Builder builder) {
        ...
        builder.comment(".", CCStress.Comments.su, CCStress.Comments.capacity)
                .push("capacity");
    ...
    private static void assertFromCreateCC(BlockBuilder<?, ?> builder) {
        if (!builder.getOwner().getModid().equals(MOD_ID)) {
            throw new IllegalStateException("Non-Create Crafts And Construct blocks cannot be added to Create CC's config.");
        }
    }
