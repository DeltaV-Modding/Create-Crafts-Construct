...
public class SturdyHosePulleyRenderer extends AbstractPulleyRenderer<HosePulleyBlockEntity> {

    public SturdyHosePulleyRenderer(BlockEntityRendererProvider.Context context) {
        super(context, AllPartialModels.HOSE_HALF, ModPartialModels.STURDY_HOSE_PULLEY_ROPE_HALF_MAGNET);
    }
    ...
    protected SuperByteBuffer renderMagnet(HosePulleyBlockEntity be) {
        return CachedBuffers.partial(ModPartialModels.STURDY_HOSE_PULLEY_MAGNET, be.getBlockState());
    }
