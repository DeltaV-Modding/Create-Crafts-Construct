...
public class SturdyFluidValveVisual extends ShaftVisual<FluidValveBlockEntity> implements SimpleDynamicVisual {
    ...
    public SturdyFluidValveVisual(VisualizationContext context, FluidValveBlockEntity blockEntity, float partialTick) {
        ...
        pointer = instancerProvider()
                .instancer(InstanceTypes.TRANSFORMED, Models.partial(SturdyFluidValveRenderer.getPointer(state)))
                .createInstance();
