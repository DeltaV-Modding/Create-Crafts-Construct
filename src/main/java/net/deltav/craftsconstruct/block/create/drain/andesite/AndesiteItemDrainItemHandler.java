...
public class AndesiteItemDrainItemHandler implements IItemHandler {

    private final AndesiteItemDrainBlockEntity blockEntity;
    private final Direction side;

    public AndesiteItemDrainItemHandler(AndesiteItemDrainBlockEntity be, Direction side) {
        this.blockEntity = be;
        this.side = side;
    }
    public int getSlots() {
