...
public class AndesiteFluidTankRenderer extends FluidTankRenderer {
    private static final Map<String, Partials> PARTIALS = new HashMap<>();

    public AndesiteFluidTankRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }
    ...
    private static Partials getPartials(BlockState state) {
        ...
        PartialModel dial = net.deltav.craftsconstruct.registry.ModPartialModels.STEAM_ENGINE_DIALS.get(steamEnginePath);
