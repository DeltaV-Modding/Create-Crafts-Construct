...
public class AndesiteFluidValveVisual extends ShaftVisual<FluidValveBlockEntity> implements SimpleDynamicVisual {
    ...
    public AndesiteFluidValveVisual(VisualizationContext context, FluidValveBlockEntity blockEntity, float partialTick) {
        ...
        pointer = instancerProvider()
                .instancer(InstanceTypes.TRANSFORMED, Models.partial(AndesiteFluidValveRenderer.getPointer(state)))
                .createInstance();
