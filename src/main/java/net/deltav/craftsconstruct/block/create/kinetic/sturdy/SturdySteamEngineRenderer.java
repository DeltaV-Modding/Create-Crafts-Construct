...
public class SturdySteamEngineRenderer extends SafeBlockEntityRenderer<SteamEngineBlockEntity> {
    public SturdySteamEngineRenderer(BlockEntityRendererProvider.Context context) {
        super();
    }
